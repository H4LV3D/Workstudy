                ...
                <form action="addstudent.php" class="form" method="POST">
                    ...
                    <div class="py-4">
                        ...
                        <div class="form-group col-12 col-md-10 col-lg-6 mx-auto">
                            ...
                            <input type="tel" required class="form-control" name="Phone_Number" value="" size="11" placeholder="081 593 3370" autocomplete="on" required />
                        </div>
                    </div>
                    <div class="form-group col-12 col-md-10 col-lg-6  mt-2 mx-auto d-flex justify-content-end">
                        <button class="btn btn-block btn-large w-100 py-3 text-white mx-auto " type="submit" style="background-color: #996399; border: 1px solid #996399;">
                            Register
                        </button>
                    </div>
                </form>
