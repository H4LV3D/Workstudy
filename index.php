                ...
                <div class="col-12 bg-white shadow rounded p-4 p-md-5">
                    ...
                    <div class="col-12 mb-5 my-md-5 px-lg-5">
                        ...
                        <div class="dropdown show">
                            <div class="text-secondary" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-md-6 col-lg-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-12 col-sm-6 col-md-3 text-md-center">
                                <a href="https://www.instagram.com/studentcouncil_cu/" class="btn"><i class="fab fa-telegram fa-lg fa-fw pr-3"></i>Telegram</a>
                            </div>
                            <div class="col-12 col-sm-6 col-md-3  text-md-center">
                                <a href="change-password.php" class="btn d-flex align-items-center justify-content-center">
